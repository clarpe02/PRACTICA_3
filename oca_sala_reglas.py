# -*- coding: utf-8 -*-
"""
Created on Sun Apr 24 02:33:28 2022
    ...
    def ejecutar_turno(self,n):
        ...
        if self.bloqueo[n]==True:
            ...
            #f.move_hasta(62-dif)            
                ...
                print("Has caido en la posada, dos turnos sin tirar")
            elif casilla==56:
                self.bloque[n]=True
                self.turnos_bloqueo[n]=3
                print("Has caido en la prisión, tres turnos sin tirar")
